...
import { Settings, Users, Shield, ShieldCheck, Save, UserPlus, Eye, EyeOff, Pencil, Lock, ArrowRightLeft, AlertTriangle, UserX, UserCheck, Trash2 } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl animate-slide-up">
      ...
      {/* Verifica in due passaggi — gestita dalla pagina dedicata (MFA nativo) */}
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            <Shield size={20} className="text-pw-text-dim" />
            <h2 className="text-lg font-semibold text-pw-text">Verifica in due passaggi (2FA)</h2>
          </div>
        </CardHeader>
        <CardContent className="space-y-3">
          <p className="text-sm text-pw-text-muted">
            L&apos;attivazione, il codice e la rimozione del secondo fattore si gestiscono dalla pagina dedicata.
          </p>
          <a href="/sicurezza-2fa" className="inline-flex items-center gap-2 rounded-lg bg-pw-surface-2 px-3 py-2 text-sm font-medium text-pw-text hover:bg-pw-surface-3 transition-colors">
            <ShieldCheck size={16} /> Gestisci la 2FA
          </a>
        </CardContent>
      </Card>
